...
```
Server name: NATOclassificationconverter
...
**Done!** In Claude Desktop, look for your MCP server named `NATOclassificationconverter` in the available tools. Your GraphQL API is now accessible to your AI assistant!

**Try it:** Ask Claude "What tools do I have available?" or "Can you get me some information about `NATOclassificationconverter`?"
...
2. **Select your graph**: Choose `NATOclassificationconverter` from the dropdown
